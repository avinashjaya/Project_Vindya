	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 1:
				...
				fbs.setStudentName(sc.next());
				System.out.println("Enter Student Mobile Number ?");
				fbs.setMobileNumber(sc.nextLong());
				...
				System.out.println("Student Name   :   " + fbs.getStudentName());
				System.out.println("Student Mobile :   " + fbs.getMobileNumber());
			...
			case 2:
				...
				System.out.println("Enter Student Name ?");
				cbs.setStudentName(sc.next());
				System.out.println("Enter Student Mobile Number ?");
				cbs.setMobileNumber(sc.nextLong());
				System.out.println("Enter Student Address ?");
				...
				System.out.println("Student Name   :   " + cbs.getStudentName());
				System.out.println("Student Mobile :   " + cbs.getMobileNumber());
			...
			case 3:
				...
				System.out.println("Enter Student Name ?");
				wbs.setStudentName(sc.next());
				System.out.println("Enter Student Mobile Number ?");
				wbs.setMobileNumber(sc.nextLong());
				System.out.println("Enter Student Address ?");
				...
				System.out.println("Student Name   :   " + wbs.getStudentName());
				System.out.println("Student Mobile :   " + wbs.getMobileNumber());
			...
			case 4:
				...
				System.out.println("Enter Student Name ?");
				cwbs.setStudentName(sc.next());
				System.out.println("Enter Student Mobile Number ?");
				cwbs.setMobileNumber(sc.nextLong());
				System.out.println("Enter Student Address ?");
				...
				System.out.println("Student Name   :   " + cwbs.getStudentName());
				System.out.println("Student Mobile :   " + cwbs.getMobileNumber());
